...
public class DeviceConnFactoryManager {
    ...
    public void sendDataImmediately(final Vector<Byte> data) {
        ...
        try {
//            PrintUtils.setOutputStream(this.mPort.getOutputStream());
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case READ_DATA:
                    ...
                    Log.i(TAG, "handleMessage,DATA CNT: "+cnt +" buffer array:"+buffer[0] + "result:"+result +" 当前模式："+currentPrinterCommand);
                    break;
                default:
                    break;
            }
